...
uint8_t get_mac_with_arp_wait(void); // checks current ongoing transaction, returns 0 when the transaction is over
#endif
...
// cache of routers and switches. It can improve the response
